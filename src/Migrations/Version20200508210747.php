 ...
 */
final class Version20200508210747 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette ADD vente TINYINT(1) NOT NULL, ADD prix DOUBLE PRECISION DEFAULT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE pack_ingredient_id pack_ingredient_id INT DEFAULT NULL, CHANGE membre_id membre_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette DROP vente, DROP prix, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE pack_ingredient_id pack_ingredient_id INT DEFAULT NULL, CHANGE membre_id membre_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
    }
}
