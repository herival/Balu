 ...
 */
final class Version20200509212739 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pack_ingredient ADD quantite DOUBLE PRECISION NOT NULL, ADD unite VARCHAR(20) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pack_ingredient DROP quantite, DROP unite');
