 ...
 */
final class Version20200513122127 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette ADD note DOUBLE PRECISION DEFAULT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE membre_id membre_id INT DEFAULT NULL, CHANGE souscategorie_id souscategorie_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL, CHANGE prix prix DOUBLE PRECISION DEFAULT NULL, CHANGE cuisson cuisson TIME DEFAULT NULL, CHANGE tpspreparation tpspreparation TIME DEFAULT NULL, CHANGE nbrepersonne nbrepersonne INT DEFAULT NULL, CHANGE difficulte difficulte VARCHAR(100) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette DROP note, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE membre_id membre_id INT DEFAULT NULL, CHANGE souscategorie_id souscategorie_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE prix prix DOUBLE PRECISION DEFAULT \'NULL\', CHANGE cuisson cuisson TIME DEFAULT \'NULL\', CHANGE tpspreparation tpspreparation TIME DEFAULT \'NULL\', CHANGE nbrepersonne nbrepersonne INT DEFAULT NULL, CHANGE difficulte difficulte VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
    }
}
